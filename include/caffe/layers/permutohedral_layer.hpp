...
namespace caffe {
  ...
  template <>
  struct
  PermutohedralTypeTraits<permutohedral::Permutohedral> {
    static const char* type() { return "Permutohedral" ;}
  };

  template <>
  struct
  PermutohedralTypeTraits<permutohedral::GaussPermutohedral> {
  ...
  public:
    explicit PermutohedralLayerTemplate(
