...
class PermutohedralReverse {
 public:
  ...
  virtual
  void compute_Ldiff(const value_type* in, value_type* out) = 0;
...
class Permutohedral {
 public:
  ...
  struct Lattice {
    ...
    std::vector<value_type> barycentric_Ldiff_;
    std::vector<int> offset_;
    std::vector<int> offset_Ldiff_;
...
/************************************************/
    ...
    class PermutohedralReverseCpu : public PermutohedralReverse<T> {
     ...
     private:
      ...
      void slice_Ldiff(const std::vector<value_type>& data,
                 value_type* sliced) const;    
 ...
 private:
  ...
  void slice_Ldiff(const Blob<value_type>& data,
             value_type* sliced) const;    
  ...
  Blob<value_type> barycentric_Ldiff_;
  Blob<int> offset_;
  Blob<int> offset_Ldiff_;
